...
- [ ] Добавить миграции и сиды для основных таблиц.
>>>>>>> 287d30f6683aee7d0ceb947ec48be81f1f49427f

---

### Phase 2: Authorization & Header Personalization

- [ ] Реализовать модель `users` с полями `name`, `role`, `access_code_hash`.
- [ ] Добавить 11 сотрудников (дизайнеры, производство, директор, админ) в сиды.
- [ ] Сделать экран авторизации по коду доступа (без логина/пароля).
- [ ] Реализовать выдачу и проверку токена (JWT или сессии).
- [ ] Сформировать в хэдере приветствие по времени суток + имя + мотивационная фраза.
- [ ] Добавить иконку уведомлений и счётчик непрочитанных.
