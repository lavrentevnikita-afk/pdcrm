...
- [v] Реализовать сущности `products`, `product_categories`.
- [v] Реализовать модель `product_price_tiers` (скидки/цены по тиражам).
- [v] Реализовать список заказов с фильтрами (мои / все, статус, даты, клиент).
- [ ] Реализовать создание заказа через кнопку и растягиваемый drawer
- [ ] Реализовать добавление в справочники, всего чего можно
